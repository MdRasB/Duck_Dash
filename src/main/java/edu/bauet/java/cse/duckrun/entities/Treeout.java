...
public class Treeout extends Obstacle {

    public Treeout(double startX, double startY, double worldSpeed) {
        ...
        view.setImage(AssetLoader.getImage("/images/obstacles/plant1.png"));
